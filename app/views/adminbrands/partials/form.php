  ...
  <div class="modal-dialog" role="document">
    <div class="modal-content">
      <div class="modal-header">
        <h5 class="modal-title" id="addBrandFormLabel">Adaugă o categorie</h5>
      ...
      <div class="modal-footer">
        ...
        <button type="button" class="btn btn-primary" onclick="saveBrand()">Salvează modificările</button>
      </div>
    </div>
  </div>
</div>
