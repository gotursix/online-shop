  ...
  <div class="col-md-8 bg-light p-3">
    ...
    <form action="" method="POST" enctype="multipart/form-data">
      ...
      <div class="row">
       ...
       <?= FH::selectBlock('Categorie','brand_id',$this->product->brand_id,$this->brands,['class'=>'form-control input-sm','onkeyup'=>'sync()'],['class'=>'form-group col-md-3'],$this->displayErrors) ?>
      </div>
      <div class="row">
